/*---------------------------------------app.component.html--------------------------------------*/
<h3>Develop a Angular Project that show cases the following Event binding :-  a) Text Box’s key entry b) Button on Click c) Text Box Key Enter d) Text Area Keyup +Shift +A </h3>
<div class="container">
     <div>
